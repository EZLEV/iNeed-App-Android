...
import shop.ineed.app.ineed.util.TextUtils;
import shop.ineed.app.ineed.util.UrlPreviewInfo;
import shop.ineed.app.ineed.util.WebUtils;
...
public class GroupChatFragment extends Fragment {
    ...
    public static GroupChatFragment newInstance(@NonNull String channelUrl) {
        ...
        args.putString(DetailsProductFragment.Companion.getEXTRA_GROUP_CHANNEL_URL(), channelUrl);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mChannelUrl = getArguments().getString(DetailsProductFragment.Companion.getEXTRA_GROUP_CHANNEL_URL());
        }
